                    ...
                    <div className="flex flex-col gap-4 max-w-xs mx-auto">
                        {links.map((link, index) => (
                            <motion.a
                                ...
                                className={`inline-flex items-center justify-center gap-3 px-8 py-4 rounded-xl transition-all duration-300 group/link font-medium text-lg ${link.type === 'whatsapp'
