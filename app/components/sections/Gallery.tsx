...
const GalleryItem = ({
  ...
  useEffect(() => {
    ...
    const preventScrollPassive = (e: Event) => e.preventDefault();

    document.addEventListener('touchmove', preventScroll, { passive: false });
    document.addEventListener('wheel', preventScrollPassive, {
      passive: false,
    });
    ...
    return () => {
      ...
      document.removeEventListener('wheel', preventScrollPassive);
  ...
  return (
    ...
    >
      ...
      <div
        ref={containerRef}
        className="relative w-full aspect-[4/3] select-none touch-none cursor-ew-resize bg-secondary/50 overflow-hidden"
      ...
      >
        ...
        <div className="absolute inset-0">
          <Image src={afterImage} alt={`${title} - After`} {...imageProps} />
        </div>
          ...
          {(isHovered || isDragging) && (
            <>
              <motion.div
                ...
                className="absolute top-4 left-4 px-4 py-2 bg-black/60 backdrop-blur-md rounded-xl text-sm font-medium text-white shadow-lg"
              >
                Before
              </motion.div>
              <motion.div
                ...
                exit={{ opacity: 0, y: -10 }}
                transition={{ duration: 0.2 }}
                className="absolute top-4 right-4 px-4 py-2 bg-black/60 backdrop-blur-md rounded-xl text-sm font-medium text-white shadow-lg"
              >
                After
              </motion.div>
            </>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          <p className="text-gray-300/90 mb-6">
            Explore our complete portfolio of transformations
          </p>
          <a
            href="/gallery"
